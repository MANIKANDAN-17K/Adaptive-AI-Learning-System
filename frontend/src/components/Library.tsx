...
export default function Library({
  ...
  const [filter, setFilter] = useState<"all" | "in-progress" | "mastered">(
    "all",
  );
    ...
    return (
      ...
      >
        ...
        >
          ...
          />
          <p style={{ color: "#9585cc", fontSize: 14, fontWeight: 600 }}>
            Loading your skills…
          </p>
        </motion.div>
      </div>
      ...
      >
        ...
        <motion.div
          style={{
            ...
            boxShadow: "0 8px 32px rgba(108,77,255,0.1)",
          }}
      ...
      >
        ...
        <motion.div
          style={{
            ...
            padding: 56,
            border: "1.5px solid #ede9ff",
            boxShadow: "0 12px 40px rgba(108,77,255,0.1)",
          }}
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        >
          ...
          >
            You haven't created any skills yet. Start your learning journey by
          ...
          {onBack && (
            <motion.button
              ...
              style={{
                ...
                fontFamily: "'Nunito', sans-serif",
                boxShadow: "0 6px 24px rgba(108,77,255,0.38)",
              }}
            >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {skills.length} {skills.length === 1 ? "skill" : "skills"} · Keep
          ...
          >
            {[
              ...
              {
                label: "Mastered",
                value: skills.filter((s) => s.masteryLevel >= 80).length,
                icon: (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
              ...
              {
                label: "Avg Progress",
                value: `${Math.round(skills.reduce((a, s) => a + s.progressPercentage, 0) / skills.length)}%`,
                icon: (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
          ...
          {(["all", "in-progress", "mastered"] as const).map((f) => (
            ...
            >
              {f === "all"
                ...
                : f === "in-progress"
                  ? `In Progress (${skills.filter((s) => s.masteryLevel < 80).length})`
                  : `Mastered (${skills.filter((s) => s.masteryLevel >= 80).length})`}
            </button>
          ))}
        </motion.div>
          ...
          >
            {filteredSkills.map((skill, index) => {
              ...
              const completedLessons = Math.round(
                (skill.progressPercentage / 100) * 12,
              );
