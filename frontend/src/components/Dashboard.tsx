    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 16, color: '#2d1f6e', letterSpacing: '-0.2px' }}>
            AI Skill Mentor
          </span>
        </div>
      ...
      <main style={{
        ...
        >
          <p style={{ fontSize: 12, fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#a598d8', marginBottom: 8 }}>
            Your Dashboard
          </p>
          <h1 style={{
            fontFamily: "'Syne', sans-serif",
            fontSize: 'clamp(22px, 4vw, 34px)',
            fontWeight: 800, color: '#2d1f6e',
            margin: 0, lineHeight: 1.2,
          }}>
            Welcome back, {user.name} 👋
          </h1>
          <p style={{ marginTop: 10, color: '#9585cc', fontSize: 14, fontWeight: 500 }}>
        ...
        >
          ...
          {[0, 1, 2].map(i => (
            <div key={i} className="pulse-ring" style={{ position: 'absolute', left: '50%', top: '50%' }} />
          ))}
        ...
        >
          ...
          >
            ...
            <div className="card-title" style={{ color: 'white' }}>Create Skill</div>
            <div className="card-desc" style={{ color: 'rgba(255,255,255,0.72)' }}>
              Define a new skill and let AI build a personalised learning roadmap for you.
            </div>
            <div className="card-cta" style={{ color: 'rgba(255,255,255,0.85)' }}>
              Get started
          ...
          >
            <div className="icon-wrap" style={{ background: '#ede9ff' }}>
              <svg width="22" height="22" fill="none" stroke="#6C4DFF" viewBox="0 0 24 24" strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
              </svg>
            </div>
            <div className="card-title" style={{ color: '#2d1f6e' }}>Your Library</div>
            <div className="card-desc" style={{ color: '#9585cc' }}>
              Browse all your saved skills and continue tracking your mastery progress.
            </div>
          ...
          >
            ...
            <div className="card-title" style={{ color: '#2d1f6e' }}>Profile</div>
            <div className="card-desc" style={{ color: '#9585cc' }}>
              View and update your personal info, preferences and learning settings.
            </div>
            <div className="card-cta" style={{ color: '#6C4DFF' }}>
              View profile
              <svg width="13" height="13" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
        ...
        {/* Footer tagline */}
        <motion.p
          style={{ marginTop: 52, color: '#c4b8e8', fontSize: 12, fontWeight: 600, letterSpacing: '0.05em' }}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 1 }}
        >
